...
namespace Algo {
	...
	///@brief   The first method to convert a BGR image into a grayscale image.
	///@details This is the most common method. It is fast and simple.
	///@details This method uses this formula: Gray = (Red + Green + Blue) / 3
	///@param   const cv::Mat& inImage
	///@param   cv::Mat& outImage
	///@return  bool
	bool ALGORITHMS_API Averaging(const cv::Mat& inImage, cv::Mat& outImage);

	///@brief   The second method to convert a BGR image into a grayscale image. (The weighted method)
	...
	///@details This method uses this formula: Gray = ( Max(Red, Green, Blue) + Min(Red, Green, Blue) ) / 2
	///@param   const cv::Mat& inImage
	///@param   cv::Mat& outImage
	///@return  bool
	bool ALGORITHMS_API Desaturation(const cv::Mat& inImage, cv::Mat& outImage);

	///@brief   The forth method to convert a BGR image into a grayscale image.
	...
	///@details This method uses this formula: Gray = Max(Red, Green, Blue)
	///@param   const cv::Mat& inImage
	///@param   cv::Mat& outImage
	///@return  bool
	bool ALGORITHMS_API Maximum_decomposition(const cv::Mat& inImage, cv::Mat& outImage);

	///@brief   The fifth method to convert a BGR image into a grayscale image.
	///@details This algorithm can be considered a simpler method of the desaturation algorithm.
	///details  The algorithm sets each pixel to minimum red, green and blue values.
	///@details This method uses this formula: Gray = Min(Red, Green, Blue)
	///@param   const cv::Mat& inImage
	///@param   cv::Mat& outImage
	///@return  bool
	...
	///@brief   The sixth method to convert a BGR image into a grayscale image.
	...
	///@details This method uses this formula: Gray = Red or Gray = Green or Gray = Blue
	///@param   const cv::Mat& inImage
	///@param   cv::Mat& outImage
	...
	///@brief   The seventh method to convert a BGR image into a grayscale image.
	///@details This algorithm allows the user to choose how many shades of gray the resulting image will be.
	///details  Any value between 2 and 256 is accepted. (the value is entered as a parameter -> conversionFactor)
	...
	///@details ConversionFactor = 255 / (NumberOfShades - 1)
